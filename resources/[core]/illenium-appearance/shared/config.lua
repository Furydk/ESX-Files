...
Config.PedMenuGroup = "group.user"
...
Config.Stores = {
    ...
    },
    {
        ...
        --targetScenario = "" -- overrides the target scenario configure for the group
        points = {
            vector3(-570.00750732422, -911.34002685547, 23.8590),
            vector3(-566.49633789062, -911.32800292969, 23.8590),
            vector3(-566.10266113281, -917.69543457031, 23.8590),
            vector3(-570.06982421875, -917.41003417969, 23.8590)
        }
    },
    {
        type = "clothing",
        ...
        --targetScenario = "" -- overrides the target scenario configure for the group
        points = {
            vector3(-572.99859619141, -915.85394287109, 19.0442),
            vector3(-569.82452392578, -916.10455322266, 19.0442),
            vector3(-569.34130859375, -920.50250244141, 19.0442),
            vector3(-571.91412353516, -922.15930175781, 19.0442),
            vector3(-574.30224609375, -922.09832763672, 19.0442),
            vector3(-574.3564453125, -919.53747558594, 19.0442),
            vector3(-572.18865966797, -920.13275146484, 19.0442)
        }
    },
    {
        type = "clothing",
