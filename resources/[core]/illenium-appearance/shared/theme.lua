    ...
    themes = {
        {
            ...
            fontFamily = "Inter",
            primaryBackground = "23, 139, 0",
            primaryBackgroundSelected = "23, 139, 0",
        ...
        },
        {
            ...
            fontFamily = "Poppins",
            primaryBackground = "25, 113, 194",         -- Blue color
            primaryBackgroundSelected = "25, 113, 194", -- Blue color
            secondaryBackground = "0, 0, 0",            -- Dark blue color
            scaleOnHover = true,
